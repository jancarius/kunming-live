...
<table class="content box box-success" width="100%" cellspacing="1" cellpadding="0">
	<tr>
		<td style="font-size: 10.5pt;font-weight: bold;">
		...
		<td valign="top">
		 ...
		 <li runat="server" id="ModerateLi"><a href='#<%# this.ModerateTab.ClientID %>'><YAF:LocalizedLabel ID="LocalizedLabel46" runat="server" LocalizedTag="MODERATION" /></a></li>	
                ...
                <div id="Last10PostsTab">
                  <YAF:ThemeButton ID="SearchUser" runat="server" CssClass="btn btn-primary" TextLocalizedPage="POSTS"
