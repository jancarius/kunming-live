...
<div class="displayPostFooter">
	<div class="leftItem postInfoLeft">
        ...
        <YAF:ThemeButton ID="Albums" runat="server" CssClass="yafcssimagebutton hidden" TextLocalizedPage="ALBUM"
			TextLocalizedTag="ALBUMS" ImageThemeTag="ALBUMS" TitleLocalizedTag="ALBUMS_HEADER_TEXT" Visible="false" />
		<YAF:ThemeButton ID="Pm" runat="server" CssClass="btn btn-success btn-sm" TextLocalizedPage="POSTS"
			TextLocalizedTag="PM" ImageThemeTag="PM" TitleLocalizedTag="PM_TITLE" />
		<YAF:ThemeButton ID="Email" runat="server" CssClass="btn btn-success btn-sm" TextLocalizedPage="POSTS"
			TextLocalizedTag="EMAIL" ImageThemeTag="EMAIL" TitleLocalizedTag="EMAIL_TITLE" />
		<YAF:ThemeButton ID="Home" runat="server" CssClass="btn btn-success btn-sm" TextLocalizedPage="POSTS"
			TextLocalizedTag="HOME" ImageThemeTag="HOME" TitleLocalizedTag="HOME_TITLE" />
		<YAF:ThemeButton ID="Blog" runat="server" CssClass="yafcssimagebutton hidden" TextLocalizedPage="POSTS"
	...
	<div class="pull-right">
        <YAF:ThemeButton ID="ReportPost" runat="server" CssClass="btn btn-success btn-sm" Visible="false" TextLocalizedPage="POSTS"
