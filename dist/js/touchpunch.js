...
(function ($) {
    ...
    mouseProto._touchStart = function (event) {
        ...
        $(this.currentItem).css("top", "-5px").css("left", "5px");
    ...
    mouseProto._touchMove = function (event) {
        ...
        if (event.touches[0].pageY < $(window).scrollTop() + 50) {
            window.scrollBy(0, -10);
            //$("body").animate({
            //    scrollTop: $(window).scrollTop() - 100
            //}, 300);
        } else if (event.touches[0].pageY > ($(window).scrollTop() + window.innerHeight - 50)) {
            window.scrollBy(0, 10);
            //$("body").animate({
            //    scrollTop: $(window).scrollTop() + 100
            //}, 300);
    ...
    mouseProto._touchEnd = function (event) {
        ...
        $(this.currentItem).css("top", "initial").css("left", "initial");
